...
public class BigCommand extends SequentialCommandGroup {
  ...
  public BigCommand(Intake intake, Shooter shooter, LED led) {
    ...
    //this must be a instant command, you would need to set the feeders and flywheels at a arbituarily slow speed 
    ...
    addCommands(
    new IntakeNote([subsystem], [subsystem], [subsystem], false),
