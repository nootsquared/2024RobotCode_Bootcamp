...
public class ACTIVITYFILE extends Command {
  ...
  public ACTIVITYFILE(Drive drive, CommandXboxController controller, Shooter shooter, Pivot pivot, LED led) {
  ...
  public void angleShooter() {
    ...
    //set the distanceToSpeakerMeter to the calculateDistanceToSpeaker method
